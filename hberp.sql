...
--
-- Host: localhost
-- Generation Time: Aug 07, 2020 at 09:17 PM
...
('1', 'Hassan Brothers', 'hassanbrother@gmail.com', 'Shop 14,15 , Pak crockery market, Qasai gali, Raja Bazaar, Rawalpindi', '0515542313', 'https://www.facebook.com/hassanbrothers', 1);
...
CREATE TABLE `invoice` (
  ...
  `showBalance` varchar(255) DEFAULT NULL,
  `gTotal` varchar(255) DEFAULT NULL,
  `paidamount` varchar(255) DEFAULT NULL,
  `expense` varchar(255) DEFAULT '0',
  `status` int(2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(568, 'manage_location', 'Manage Location'),
(569, 'add_location', 'Add Location'),
(570, 'Location', 'Location'),
(571, 'add_new_location', 'Add new location'),
(572, 'location_name', 'Location Name'),
(573, 'manage_your_location', 'Manage your location'),
(574, 'location_edit', 'Location Edit'),
(575, 'location_not_selected', 'Location not selected.'),
(576, 'location_id', 'Location ID'),
(577, 'transection_location', 'Select  Location'),
(578, 'sales_report_location_wise', 'Sales Report (Location wise)'),
(579, 'purchase_report_location_wise', 'Purchase Report (Location wise)'),
(580, 'location_wise_purchase_report', 'Category wise purchase report'),
(581, 'location_wise_sales_report', 'Location wise sales report'),
(582, 'manage_store_location', 'Manage Store Location'),
(583, 'add_store_location', 'Add Store Location'),
(584, 'store_location', 'Store Location'),
(585, 'add_new_store_location', 'Add new store location'),
(586, 'store_location_name', 'Store Location Name'),
(587, 'manage_your_store_location', 'Manage your Store Location'),
(588, 'store_location_edit', 'Store Location Edit'),
(589, 'store_location_not_selected', 'Store Location not selected.'),
(590, 'store_location_id', 'Store Location ID'),
(591, 'transection_store_location', 'Select  Store Location'),
(592, 'sales_report_location_wise', 'Sales Report (store location wise)'),
(593, 'purchase_report_store_location_wise', 'Purchase Report (store location wise)'),
(594, 'store_location_wise_purchase_report', 'store location wise purchase report'),
(595, 'store_location_wise_sales_report', 'store location wise sales report');
...
CREATE TABLE `store_location` (
  `store_location_id` varchar(255) DEFAULT NULL,
  `store_location_name` varchar(255) DEFAULT NULL,
  `status` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `transection` (
  ...
  `notIncluded` varchar(255) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
('1', 'Ameen', 'Muhammad', 1, '', 'http://localhost/demo_hberp/assets/dist/img/profile_picture/20c4b2d54d3afdc4a5e80e6566b85d6a.jpg', 0),
('oZTpXAmq4itvJmY', 'TPoint', 'Emmi', 0, '', NULL, 1),
('KKPxGec3AKK711H', 'Hassan', 'Haris', 0, '', 'http://localhost/ERP/assets/dist/img/profile_picture/f0b7661c77653ba88d50951b460a43c2.png', 1),
('p5HTd8pknI6joce', 'Hassan', 'Haris', 0, '', 'http://localhost/demo_hberp/assets/dist/img/profile_picture/3d9f5314cbbb7f5887582e99578272e3.png', 1);
...
('1', 'test@test.com', 'a2dfc5b62260a96fda44c26053fc0c73', 1, '', 1),
('oZTpXAmq4itvJmY', 's@demo.com', '41d99b369894eb1ec3f461135132d8bb', 2, '', 1),
('KKPxGec3AKK711H', 'harishassan6@gmail.com', 'e84c36fcfd8fe0a508f87c683191a126', 1, '', 1),
('p5HTd8pknI6joce', 'harishassan6@gmail.com', 'cb1418b211229be8d50796c37a3de698', 1, '', 1);
...
CREATE TABLE `web_setting` (
  ...
  `show_product_id` int(11) DEFAULT NULL,
  `show_product_price` int(11) DEFAULT NULL,
  `show_company_name` int(11) DEFAULT NULL,
  `show_invoice_model` int(11) DEFAULT NULL,
  `show_invoice_store_model` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `web_setting` (`setting_id`, `logo`, `invoice_logo`, `favicon`, `currency`, `currency_position`, `footer_text`, `language`, `rtr`, `captcha`, `site_key`, `secret_key`, `discount_type`, `show_product_id`, `show_product_price`, `show_company_name`, `show_invoice_model`, `show_invoice_store_model`) VALUES
(1, 'http://localhost/demo_hberp/my-assets/image/logo/4ee9ad158bad66971e43ec014d25e021.png', 'http://localhost/demo_hberp/my-assets/image/logo/953683bac2527d6cdc71ceb092bf5257.png', 'http://localhost/demo_hberp/my-assets/image/logo/06d2f64e27215c418d067289868f94e3.png', '₨', '0', 'Copyright © 2019-2020 Better.AI All rights reserved.', 'english', '0', 1, '', '', 1, 0, 1, 0, 0, 0);
...
--
ALTER TABLE `language`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=596;
