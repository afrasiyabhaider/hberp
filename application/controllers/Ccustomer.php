...
class Ccustomer extends CI_Controller {
	...
	//customer_search_item
    public function customer_location_search_item() {
        $location_name = $this->input->post('location_name');
        $content = $this->lcustomer->customer_location_search_item($location_name);
        $this->template->full_admin_html_view($content);
    }
    ...
    public function manage_customer() {
        ...
        $config["per_page"] = $this->Customers->customer_list_count(); // 10;
