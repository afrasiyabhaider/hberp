...
class Cbarcode extends CI_Controller {
	...
	public function barcode_print($product_id){
		...
		$data = array(
			    ...
			    'position'	    => $setting_detail[0]['currency_position'],								'show_product_id'	    => $setting_detail[0]['show_product_id'],				'show_product_price'	    => $setting_detail[0]['show_product_price'],				'show_company_name'	    => $setting_detail[0]['show_company_name'],
