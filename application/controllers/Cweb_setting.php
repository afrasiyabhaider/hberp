...
class Cweb_setting extends CI_Controller {
    ...
    public function update_setting() {
        ...
        $data = array(
            ...
            'show_product_id' => $this->input->post('show_product_id'),
            'show_product_price' => $this->input->post('show_product_price'),       
            'show_company_name' => $this->input->post('show_company_name'),
            'show_invoice_model' => $this->input->post('show_invoice_model'),
            'show_invoice_store_model' => $this->input->post('show_invoice_store_model'),
        );
