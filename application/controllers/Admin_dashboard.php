...
//        }
    ...
    public function total_profit_report() {
        ...
        $config["per_page"] = $this->Reports->total_profit_report_count();//10;
        $config["uri_segment"] = 3;
        $config["num_links"] = 5;
        /* This Application Must Be Used With BootStrap 3 * */
        $config['full_tag_open'] = "<ul class='pagination'>";
    ...
    public function retrieve_dateWise_SalesReports() {
        ...
        $config["per_page"] = $this->Reports->count_retrieve_dateWise_SalesReports($from_date, $to_date);//10;
        $config["uri_segment"] = 3;
        $config["num_links"] = 5;
    ...
    public function retrieve_dateWise_PurchaseReports() {
        ...
        $config["per_page"] =  $this->Reports->count_retrieve_dateWise_PurchaseReports($start_date, $end_date);//10;
        $config["uri_segment"] = 3;
        $config["num_links"] = 5;
        $config['suffix'] = '?' . http_build_query($_GET, '', '&');
        $config['first_url'] = $config["base_url"] . $config['suffix'];
