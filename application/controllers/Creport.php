...
class Creport extends CI_Controller {
    ...
    public function stock_report_product_wise() {
        ...
        $config["per_page"]  = $this->Reports->product_counter_by_supplier($supplier_id);//10;
...
// date wise product report
    public function stock_date_to_date_product_wise() {
        ...
        $config["per_page"] = $this->Reports->product_counter_by_productdatetodate($from_date, $to_date);//10;
        $config["uri_segment"] = 3;
        $config["num_links"] = 5;
    ...
    public function stock_report_supplier_wise() {
        ...
        $config["per_page"] = $this->Reports->stock_report_product_bydate_count($supplier_id, $supplier_id, $from_date, $to_date);//10;
        $config["uri_segment"] = 3;
        $config["num_links"] = 5;
        /* This Application Must Be Used With BootStrap 3 * */
        $config['full_tag_open'] = "<ul class='pagination'>";
    ...
    public function pagination($per_page, $page) {
        ...
        $config["per_page"] =  $this->Reports->product_counter($product_id);//$per_page;
