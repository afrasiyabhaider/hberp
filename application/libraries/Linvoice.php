...
//        echo '<pre>';        print_r($invoices_list);die();
    ...
    public function invoice_edit_data($invoice_id) {
        ...
        $data = array(
            ...
            'showBalance' => $invoice_detail[0]['showBalance'],
            'gTotal' => $invoice_detail[0]['gTotal'],
            'expense' => $invoice_detail[0]['expense'],
    ...
    public function invoice_html_data($invoice_id) {
        ...
        $data = array(
            ...
            'position' => $currency_details[0]['currency_position'],
            'discount_type' => $currency_details[0]['discount_type'],
            'show_invoice_model' => $currency_details[0]['show_invoice_model'],
        );
    ...
    public function pos_invoice_html_data($invoice_id) {
        ...
        $data = array(
            ...
            'expense' => $invoice_detail[0]['expense'],
            'customer_name' => $invoice_detail[0]['customer_name'],
            'customer_location' => $invoice_detail[0]['customer_location'],
            'customer_address' => $invoice_detail[0]['customer_address'],
            'customer_mobile' => $invoice_detail[0]['customer_mobile'],
            'customer_email' => $invoice_detail[0]['customer_email'],
            'final_date' => $invoice_detail[0]['final_date'],
            ...
            'currency' => $currency_details[0]['currency'],
            'position' => $currency_details[0]['currency_position'],
            'show_invoice_store_model' => $currency_details[0]['show_invoice_store_model'],
            'show_invoice_model' => $currency_details[0]['show_invoice_model'],
        );
