...
// update loan Person
    ...
    public function delete_person($person_id) {
        $this->db->where('person_id', $person_id);
        $this->db->delete('person_information');
    ...
    // delete person 
    public function delete_pesonal($pesonal_id) {
        $this->db->where('person_id', $pesonal_id);
        $this->db->delete('pesonal_loan_information');
        
        $this->db->where('person_id', $pesonal_id);
        $this->db->delete('personal_loan');
    }
    // delete person 
