...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('location_edit') ?></h1>
            <small><?php echo display('location_edit') ?></small>
            <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Clocation/location_update',array('class' => 'form-vertical', 'id' => 'location_update'))?>
                    <div class="panel-body">

                    	<div class="form-group row">
                            <label for="location_name" class="col-sm-3 col-form-label"><?php echo display('location_name') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="location_name" id="location_name" type="text" placeholder="<?php echo display('location_name') ?>"  required="" value="{location_name}">
                            </div>
                        </div>
                       <div class="form-group row">
