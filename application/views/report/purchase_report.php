                    ...
                    <div class="panel-body">
                        <div id="purchase_div" style="margin-left:2px;">
                            <div class="text-center">
                                ...
                                <h4 >{address} </h4>
                                {/company_info}
                                <h4> <?php echo display('print_date') ?>: <?php date_default_timezone_set("Asia/Karachi"); echo date("d/m/Y h:i:s"); ?> </h4>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover"  id="dataTableExample3">
                                    <thead>
                                        <tr>
