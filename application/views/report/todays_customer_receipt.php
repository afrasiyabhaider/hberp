                    ...
                    <div class="panel-body">
                        ...
                        <div id="printableArea" style="margin-left:2px;">
                            <div class="text-center">
                                ...
                                <h4 >{address} </h4>
                                {/company_info}
                                <h4> <?php echo display('print_date') ?>: <?php date_default_timezone_set("Asia/Karachi"); echo date("Y/m/d h:i:s"); ?> </h4>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover" id="dataTableExample13">
                                    <thead>
                                        <tr>
...
//                                        echo '<pre>'; print_r($todays_customer_receipt);
                                        if ($todays_customer_receipt) {
                                            ...
                                            foreach ($todays_customer_receipt as $single) {
                                                $gtotal_amount += $single->total_amount;
        ...
        <!--                                                        <td class="text-right"><?php // echo $single->total_amount;   ?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><?=$currency.$gtotal_amount?></td>
                                        </tr>
                                    </tfoot>
<!--                                    <tfoot>
                                        <tr>
