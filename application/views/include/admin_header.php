...
<aside class="main-sidebar">
    ...
    <div class="sidebar">
        ...
        <li class="treeview <?php
            ...
            ?>">
                <a href="#">
                    <i class="ti-pin"></i><span><?php echo display('location') ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
			...
			<!-- location menu start -->
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("Cstore_location")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                <a href="#">
                    <i class="ti-pin"></i><span><?php echo display('store_location') ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url('Cstore_location') ?>"><?php echo display('add_store_location') ?></a></li>
                    <li><a href="<?php echo base_url('Cstore_location/manage_store_location') ?>"><?php echo display('manage_store_location') ?></a></li>
                </ul>
            </li>
            <!-- location menu end -->
        ...
        if ($this->session->userdata('user_type') == '1') {
            ...
            <!--  loan start -->
            <li class="treeview <?php
            if ($this->uri->segment('2') == ("add_person") || $this->uri->segment('2') == ("add_loan") || $this->uri->segment('2') == ("add_payment") || $this->uri->segment('2') == ("person_edit") || $this->uri->segment('2') == ("manage_loan")) {
                echo "active";
            } else {
                echo " ";
            }
