                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
										<?php
											$chalan_no = $this->db->get('product_purchase')->num_rows() + 1;
										?>
                                        <input type="text" tabindex="3" class="form-control" readonly value="pur<?=str_pad($chalan_no, 6, '0', STR_PAD_LEFT);?>" name="chalan_no" placeholder="<?php echo display('invoice_no') ?>" id="invoice_no" required />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive" style="margin-top: 10px">
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                ...
                                <tr>								
                                    ...
                                    <td class="text-right">	<input type="text" id="discount_per" class="form-control text-right" name="discount_per" onkeyup="discount_per_fun();" placeholder="0.00" autocomplete="off"></td>		
                                </tr>    								
                                <tr>								
                                    <td style="text-align:right;" colspan="4"><b>Total Discount:</b></td>			
                                    <td class="text-right">	<input type="text" id="total_discount_ammount" class="form-control text-right" name="total_discount" onkeyup="calculate_store(1);" placeholder="0.00" autocomplete="off"></td>		
                                </tr>
                                    <tr>
                                        <td colspan="2">
...
function discount_per_fun(){
   ...
   var discount_per =  parseFloat($("#discount_per").val());
    ...
    if(discount_per > 0){
         $("#total_discount_ammount").val((sum/100)*discount_per);
    }
   var total_discount_ammount =  $("#total_discount_ammount").val();
    $("#grandTotal").val(parseFloat(gr_tot - total_discount_ammount).toFixed(2,2));
...
<script type="text/javascript">
  ...
  // Counts and limit for purchase order
    ...
    function calculate_store(sl) {
		...
		var gTotal = gr_tot - total_discount;
