                    ...
                    <?php echo form_open_multipart('Cpurchase/purchase_update',array('class' => 'form-vertical', 'id' => 'purchase_update'))?>
                        ...
                        <div class="table-responsive" style="margin-top: 10px">
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                ...
                                <td class="text-right">									
                                <input type="text" id="total_discount_ammount" onkeyup="calculate_store(1);" class="form-control text-right" name="total_discount" value="{total_discount}" placeholder="0.00" autocomplete="off">										</td>									</tr>
                                    <tr>
                                        <td colspan="2">
