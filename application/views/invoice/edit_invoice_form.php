...
<!--                                        <td>
                                ...
                                <tr class="trShow">
                                    ...
                                    <td class="text-right">
                                        <input type="text" id="showBalance" class="form-control text-right" name="showBalance" value="{showBalance}" readonly="readonly"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4"  style="text-align:right;"><b>Expense:</b></td>
                                    <td class="text-right">
                                        <input type="text" id="expense" class="form-control text-right" name="expense"  value="{expense}" />
                                    </td>
                                </tr>
                                <tr class="trShow">
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                       $("#showBalance").val(data);
                        ...
                        var showBalance = parseFloat($("#showBalance").val());
                       $("#gTotal").val((grandTotal + showBalance).toFixed(2, 2)); 
                       $("#dueAmmount").val((grandTotal + showBalance).toFixed(2, 2)); 
                    } 
                 });
            }else{
