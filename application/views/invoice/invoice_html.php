                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><div><strong>{product_name} <?php if($show_invoice_model == 1){?>
                                         -  ({product_model})
                                    <?php }?></strong></div></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4" style="display: inline-block;">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th class="grand_total">Balance :</th>
                                            <td class="grand_total"><?=number_format($showBalance,2)?></td>
                                        </tr>
                                        
                                        <tr>
                                            <th class="grand_total"><?php echo display('grand_total') ?> :</th>
                                            <td class="grand_total"><?=number_format($gTotal,2)?></td>
                                        </tr>
                                        <tr>
