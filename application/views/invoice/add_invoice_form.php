                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-8" id="payment_from_2">
        						...
        						?>
        						<div class="form-group row">
                                    <label for="address " class="col-sm-3 col-form-label">Customer Location</label>
                                    <div class="col-sm-6">
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="product_quantity[]" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" class="total_qntt_1 form-control text-right" id="total_qntt_1" value="1" placeholder="0.00" min="0" tabindex="8" required="required"/>
                                        </td>
                                        <td>
                                ...
                                <tr class="trShow">
                                    ...
                                    <td class="text-right">
                                        <input type="text" id="showBalance" class="form-control text-right" name="showBalance" value="0.00" readonly="readonly"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="6"  style="text-align:right;"><b>Expense:</b></td>
                                    <td class="text-right">
                                        <input type="text" id="expense" class="form-control text-right" name="expense"  placeholder="0.00" />
                                    </td>
                                </tr>
                                <tr class="trShow">
                                    <td colspan="6"  style="text-align:right;"><b>Grand Total:</b></td>
                                    <td class="text-right">
                                        <input type="text" id="gTotal" class="form-control text-right" name="gTotal" value="0.00" readonly="readonly"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                ...
                                <tr>
                                    <td align="center" colspan="2">
                                        <input type="button" id="get_Balance" class="btn btn-info" value="Show Balance" tabindex="14"/>
...
<script type="text/javascript">
    ...
    $('#get_Balance').click(function () {
            ...
            var SchoolHiddenId = $("#SchoolHiddenId").val();
            if(SchoolHiddenId){
                $(".trShow").show();
                $.ajax({
                    url: './Cinvoice/getBlance/'+SchoolHiddenId,
                    type: 'get',
                    success:function(data)
                    {
                       var expense = parseFloat($("#expense").val() ? $("#expense").val() : 0);
                       $("#showBalance").val(data);
                        var grandTotal = parseFloat($("#grandTotal").val());
                        var showBalance = parseFloat($("#showBalance").val());
                       $("#gTotal").val((grandTotal + showBalance).toFixed(2, 2)); 
                       $("#dueAmmount").val((grandTotal + showBalance + expense).toFixed(2, 2)); 
                    } 
                 });
            }else{
   ...
   $("#expense").keyup(function(){
        ...
        var grandTotal = parseFloat($("#grandTotal").val());
        var showBalance = parseFloat($("#showBalance").val());
        $("#gTotal").val((grandTotal + showBalance + expense).toFixed(2, 2));
        $("#dueAmmount").val((grandTotal + showBalance + expense).toFixed(2, 2)); 
    });
