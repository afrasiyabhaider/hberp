                ...
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Ccustomer/customer_update',array('class' => 'form-vertical', 'id' => 'customer_update'))?>
                    <div class="panel-body">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="customer_location" id="customer_location">
									<?php foreach($location as $l){?>
										<option value="<?=$l['location_name']?>" <?php if($customer_location == $l['location_name']){echo "selected"; }?>><?=$l['location_name']?></option>
									<?php }?>
								</select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="customer_details " class="col-sm-3 col-form-label">Customer Details</label>
                            <div class="col-sm-6">
                                <textarea class="form-control" name="customer_details" id="customer_details " rows="3" placeholder="Customer Details" tabindex="4">{customer_details}</textarea>
                            </div>
                        </div>
