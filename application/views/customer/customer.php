                ...
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <form action="<?php echo base_url('Ccustomer/customer_search_item') ?>" class="form-inline" method="post" accept-charset="utf-8">
                            ...
                            <select class="form-control" name="customer_id" style="width: 50%">
                                {all_customer_list}
			...
			<div class="col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <form action="<?php echo base_url('Ccustomer/customer_location_search_item') ?>" class="form-inline" method="post" accept-charset="utf-8">

                            <label class="select">Customer Location:</label>
                            <select class="form-control" name="location_name" style="width: 50%">
                                <?php 
...
//                                    echo '<pre>';                                    print_r($customers_list);
		...
		(SELECT sum(amount) FROM customer_ledger WHERE d_c = "c" AND customer_id = "' . $customer['customer_id'] . '") cr';
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $customer['customer_location']; ?></td>
