...
//                                             echo  $result[0]->debit - $result[0]->credit;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="" class="deletePerson btn btn-danger btn-sm" name="<?=$person['person_id']?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
    ...
    $(".deletePerson").click(function ()
    {
        ...
        if (x == true) {
            $.ajax
                    ({
                        type: "POST",
                        url: '<?php echo base_url('Csettings/person_delete1/') ?>'+Person_id,
