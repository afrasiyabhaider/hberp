                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="dataTableExample5" class="table table-bordered table-striped table-hover"><a href="<?php echo base_url() . 'Cproduct/exportCSV'; ?>" class="btn btn-success">ExportCSV </a>
                                <thead>
                                    <tr>
