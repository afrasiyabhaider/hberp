                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">                              
                                <label for="store_location" class="col-sm-4 col-form-label"><?php echo display('store_location') ?> <i class="text-danger">*</i></label>     
                                    <div class="col-sm-8">   

                                        <select class="form-control" id="store_location" name="store_location" tabindex="-1" aria-hidden="true" required>       
                                        <option value="">Select One</option>                              
                                        <?php 							
                                        $store_location = $this->db->get('store_location')->result_array();	
                                        foreach($store_location as $sl){									
                                        ?>								
                                        <option value="<?=$sl['store_location_name']?>"><?=$sl['store_location_name']?></option>	
                                        <?php }?>                               
                                        </select>                              
                                    </div>                             
                                </div>
