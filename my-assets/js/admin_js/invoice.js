...
function addInputField(t) {
    var row = $("#addinvoiceItem tbody tr, #normalinvoice tbody tr, #addinvoice tbody tr").length; ///#addinvoice tbody tr, 
    var count = row + 1;
    var limits = 500;
    if (count == limits)
...
//Invoice Paid Amount
function invoice_paidamount() { //$("#grandTotal").val()
    var t = $("#grandTotal").val(),
            a = $("#paidAmount").val(),
            b = parseFloat($("#showBalance").val()),
            ex = parseFloat($("#expense").val() ? $("#expense").val() : 0),
            e = (parseFloat(t)+parseFloat(b)+parseFloat(ex)) - a;
